...
public class ShopCommand implements CommandExecutor, TabCompleter {
    ...
    private boolean handleReload(CommandSender sender) {
        ...
        if (sender instanceof Player) {
            ...
            player.sendPluginMessage(
                    me.minseok.shopsystem.ShopSystemBackend.getPlugin(me.minseok.shopsystem.ShopSystemBackend.class),
            ...
            if (org.bukkit.Bukkit.getOnlinePlayers().isEmpty()) {
                ...
                com.google.common.io.ByteArrayDataOutput out = com.google.common.io.ByteStreams.newDataOutput();
                out.writeUTF("REQUEST_GLOBAL_RELOAD");
                player.sendPluginMessage(me.minseok.shopsystem.ShopSystemBackend.getPlugin(
                        me.minseok.shopsystem.ShopSystemBackend.class), "shopsystem:sync", out.toByteArray());
    ...
    private boolean handleReset(CommandSender sender, String[] args) {
        ...
        if (args[1].equalsIgnoreCase("all")) {
            shopManager.reloadShops();
            sender.sendMessage("§a✓ 모든 가격을 초기화했습니다!");
        } else {
            ...
            if (item != null) {
                ...
                sender.sendMessage("§a✓ " + itemId + "의 가격을 초기화했습니다!");
            } else {
    ...
    private boolean handlePopular(CommandSender sender) {
        ...
        for (Map.Entry<String, Integer> entry : popular.entrySet()) {
            ...
            if (item != null) {
                double priceChange = ((item.getBuyPrice() - item.getBaseBuyPrice()) / item.getBaseBuyPrice()) * 100;
